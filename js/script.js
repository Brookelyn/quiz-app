...
function nextQ(){
		...
		var newA = '<div class="answer"><div class="atext"><p>' + questions[currentQ].answers[0] + '<input id="option_0" type="radio" value="0" name="test" /></p></div></div>' +
				   ...
				   '<div class="answer"><div class="atext"><p>' + questions[currentQ].answers[2] + '<input id="option_2" type="radio" value="2" name="test" /></p>< 
		$('.answer-block').html(newA).fadeIn(5000);
}
